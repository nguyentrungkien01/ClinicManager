...
from ClinicManagerApp.controller.doctor.medical_examination_controller import get_customer_id_card as gcid, \
    ...
    save_medicine_examination as sme
...
@app.route('/api/customer_id_card_doctor', methods=['post'])
...
@app.route('/api/medicine_name_doctor', methods=['post'])
...
@app.route('/api/medicine_unit_doctor', methods=['post'])
def get_medicine_unit():
    medicine_name = request.json.get('medicine_name')
    return parse_json_array([gmu(medicine_name)])


@app.route('/api/check_medicine_name_doctor', methods=['post'])
...
@app.route('/api/check_customer_id_card_doctor', methods=['post'])
...
@app.route('/api/current_doctor', methods=['post'])
...
@app.route('/api/save_medical_examination_data', methods=['post'])
