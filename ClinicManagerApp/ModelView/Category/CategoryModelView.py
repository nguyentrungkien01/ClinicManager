...
class CategoryModelView(BaseModelView):
    ...
    column_filters = (FilterEqual(column='name', name='Tên kho thuốc'),
                      FilterNotEqual(column='name', name='Tên kho thuốc'),
                      FilterLike(column='name', name='Tên kho thuốc'),
                      FilterNotLike(column='name', name='Tên kho thuốc'),
